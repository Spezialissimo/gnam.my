<div class="align-content-center p-4 h-100">
    ...
    <button type="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white w-50 mt-3" id="loginButton" aria-label="Pulsante per effettuare il login" tabindex="3">Log in</button>
    <hr class="mt-3 w-75" />
    <p class="h6 fw-bold">You don't have an account?</p>
    <a href="register.php" role="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white" aria-label="Pulsante per registrarsi" tabindex="3">Sign up</a>
