<div class="align-content-center p-4 h-100">
    ...
    <input type="password" class="form-control bg-primary rounded shadow-sm mb-3 mt-4" placeholder="Password" id="password" title="password" aria-label="Inserisci password" />
    <button type="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white w-50 mt-3" id="loginButton" aria-label="Pulsante per effettuare il login">Login</button>
    <hr class="mt-3 w-75" />
    <p class="h6 fw-bold">Non hai un account?</p>
    <a href="register.php" role="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white" aria-label="Pulsante per registrarsi">Registrati</a>
</div>
