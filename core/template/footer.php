	...
	<nav class="m-0">
		<div class="w-100 d-flex" id="navbarContentDiv">
			<div class="btn-bounce d-flex flex-row align-items-center justify-content-center">
				<a href="home.php" class="d-flex border-0 align-self-center" role="button" tabindex="1">
			...
			<div class="btn-bounce d-flex flex-row align-items-center justify-content-center">
				<a href="search.php" class="d-flex border-0 align-self-center" role="button" tabindex="1">
			...
			<div class="btn-bounce d-flex flex-row align-items-center justify-content-center">
				<a href="publish.php" class="d-flex border-0 align-self-center" role="button" tabindex="1">
			...
			<div class="btn-bounce d-flex flex-row align-items-center justify-content-center">
				<a href="notifications.php" class="d-flex border-0 align-self-center" role="button" tabindex="1">
			...
			<div class="btn-bounce d-flex flex-row align-items-center justify-content-center">
				<a href="profile.php" class="d-flex border-0 align-self-center" role="button" tabindex="1">
