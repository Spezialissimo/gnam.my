                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col align-self-center fs-7">
                                    <div class="m-0 text-link text-black d-inline"><?php echo $notification["source_user_name"];?></div><span class="m-0 text-black fw-normal"> <?php echo $notification["template_text"];?></span>
                                </div>
