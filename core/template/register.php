<div class="align-content-center p-4 h-100 text-center">
    ...
    <button type="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white w-50 mt-3" id="registerButton" aria-label="Pulsante per registrarsi" tabindex="3">Sign up</button>
    <hr class="mt-3 w-75" />
    <p class="h6 fw-bold">You already have an account?</p>
    <a href="login.php" role="button" class="btn btn-bounce rounded-pill bg-accent fw-bold text-white" aria-label="Pulsante per accedere" tabindex="3">Log in</a>
</div>
